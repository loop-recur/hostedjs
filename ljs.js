...
// UTILS
// =========================
_LambdaJS.pluck = curry(function( param, obj ){
      return obj[param];
    })

_LambdaJS.flip = function( fn ){
...
_LambdaJS.S = curry(function(f, g) {
      return function() {
        return f.apply(this, [g.apply(this, arguments)].concat(Array.slice(arguments, 0)));
      }
    })

_LambdaJS.K = function(x){
  return function() { return x; }
}

_LambdaJS.I = function(x){ return x; };
...
},{"lodash.curry":2}],2:[function(require,module,exports){
/**
